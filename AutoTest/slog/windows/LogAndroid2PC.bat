...
echo  - get dev log...
echo  - get dev log...>>%LOGFILE% 2>&1
%ADB_CMD% pull /dev/log/main.log %LOGDIR%/internal_storage/>>%LOGFILE% 2>&1
%ADB_CMD% pull /dev/log/system.log %LOGDIR%/external_storage/>>%LOGFILE% 2>&1
